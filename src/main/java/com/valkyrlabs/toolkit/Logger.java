 ...
 *  set the system property: "com.valkyrlabs.toolkit.logger"
 *  <br><br>
 *  For example:
 *  <pre>
 *  CustomLog mylogr = new CustomLog();
 *  Properties props = System.getProperties();
    props.put("com.valkyrlabs.toolkit.logger", mylogr );
 *  </pre>
 *  <br>
 *  The default Logger settings can be controlled using System properties.
 * <pre>
 * 	props.put("com.valkyrlabs.toolkit.logger.dateformat", "MMM yyyy mm:ss" );
 * 	props.put("com.valkyrlabs.toolkit.logger.dateformat", "none" );
 * 
 * </pre>
 * 
 *
...
public class Logger extends PrintStream {
	...
	public static Logger getLogger() {
		...
		try {
			logger = (Logger) System.getProperties()
					.get("com.valkyrlabs.toolkit.logger");
		} catch (Exception ex) {
			logger = null;
		}
	...
	public static void setLogger(Logger logger) {
		System.getProperties().put("com.valkyrlabs.toolkit.logger", logger);
	}
	 ...
	 * If the system property <code>com.valkyrlabs.toolkit.logger.dateformat</code>
	...
	public static String getLogDate() {
		String spec = System
				.getProperty("com.valkyrlabs.toolkit.logger.dateformat");
		if (null != spec) {
