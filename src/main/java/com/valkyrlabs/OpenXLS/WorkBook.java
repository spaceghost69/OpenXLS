...
public interface WorkBook extends Handle, Document {
     ...
     * @return
     */
    public abstract CellHandle getCell(String address) throws CellNotFoundException, SheetNotFoundException;
     ...
     * @throws SheetNotFoundExceptionthe specified WorkSheet is
     *                                   not found in the WorkBook.
     */
    public abstract WorkSheetHandle getWorkSheet(int i) throws SheetNotFoundException;
     ...
     *                                   not found in the WorkBook.
     */
    public abstract WorkSheetHandle getWorkSheet(String handstr) throws SheetNotFoundException;
     ...
     */
    public abstract com.valkyrlabs.formats.XLS.WorkBook getWorkBook();
     ...
     * can set it explicitly. The auto mode is the most flexible but requires
     * processing
     * overhead.
     * <p>
     ...
     * WorkBookHandle.STRING_ENCODING_UNICODE Use if all of your new Strings are
     * Unicode - faster than AUTO
     * -faster than AUTO
     * -largest file size
     * WorkBookHandle.STRING_ENCODING_COMPRESSED Use if all of your new Strings are
     * non-Unicode and can have high-bytes compressed
     * -faster than AUTO
     * -smallest file size
     *
     ...
     * Valid Modes Are:
     * <p>
     * WorkBookHandle.ALLOWDUPES - faster, smaller file sizes, dupe Cells share
     * changes
     * WorkBookHandle.SHAREDUPES - slower inserts, changing Cells has no effect on
     * dupe Cells
     *
     ...
     * @param sheet
     */
    public abstract void copyChartToSheet(ChartHandle chart, WorkSheetHandle sheet)
            throws ChartNotFoundException, SheetNotFoundException;
     ...
     */
    public abstract WorkSheetHandle copyWorkSheet(String SourceSheetName, String NewSheetName)
     ...
     * @throws SheetNotFoundException;
     */
    public abstract boolean addSheetFromWorkBook(WorkBookHandle sourceBook, String sourceSheetName,
