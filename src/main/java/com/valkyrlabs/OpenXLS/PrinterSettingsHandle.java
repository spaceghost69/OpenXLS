...
import com.valkyrlabs.formats.XLS.BottomMargin;
import com.valkyrlabs.formats.XLS.Boundsheet;
import com.valkyrlabs.formats.XLS.HCenter;
import com.valkyrlabs.formats.XLS.LeftMargin;
import com.valkyrlabs.formats.XLS.Name;
import com.valkyrlabs.formats.XLS.PrintGrid;
...
/**
 * The PrinterSettingsHandle gives you control over the printer settings for a
 * Sheet such as whether to print in landscape or portrait mode.
 * <br/>
 * <br/>
 * The PrinterSettingsHandle provides fine-grained control over printing
 * settings
 * in Excel.
 * <br/>
 * <br/>
 * NOTE: you can only view the effects of these methods in an open Excel file
 * when
...
public class PrinterSettingsHandle implements Handle {
	...
	// public static final int PAPER_SIZE_B4_ISO_250MM_X_353MM = 42 ; // B4 (ISO)
	// 250mm x 353mm
