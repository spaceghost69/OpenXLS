...
public interface WorkSheet extends Handle{
	...
	*/
	...
	/** returns the Column at the named position
	    ...
	    @return ColHandle the Column
	*/
	public abstract ColHandle getCol(String name)
	...
	*/
	public abstract void removeRow(int rownum, boolean shiftrows)
	...
	*/
	public abstract void removeCol(String colstr)
		throws ColumnNotFoundException;
	/** Remove a Column and all associated Cells from
	    this WorkSheet.
	...
	*/
	public abstract void removeCol(String colstr, boolean shiftcols)
		throws ColumnNotFoundException;
	
	/** Returns the low-level OpenXLS Sheet.
	 * 
	 * @return com.valkyrlabs.formats.XLS.Sheet
	 */
	...
	*/
	...
	/** Set the Object value of the Cell at the given address.
	    ...
	    @exception CellNotFoundException is thrown if there is 
	    no existing Cell at the specified address.
	*/
	public abstract void setVal(String address, Object val)
	...
	/** Set the String value of the Cell at the given address
	    ...
	    @exception CellNotFoundException is thrown if there is no existing Cell at the specified address.
	*/
	public abstract void setVal(String address, String s)
		throws CellNotFoundException, CellTypeMismatchException;
	...
	*/
	public abstract CellHandle add(
		java.util.Date dt,
		String address,
		String fmt);
	...
	*/
	...
	/** Returns a FormulaHandle for working with
	    ...
	    @exception FormulaNotFoundException is thrown if there is no existing formula at the specified address.
	*/
	public abstract FormulaHandle getFormula(String addr)
	...
	/** Returns a CellHandle for working with
	    ...
	    @exception CellNotFoundException is thrown if there is no existing Cell at the specified address.
	*/
	public abstract CellHandle getCell(String addr)
	...
	/** Returns a CellHandle for working with
	    ...
	    @exception CellNotFoundException is thrown if there is no existing Cell at the specified address.
	*/
	public abstract CellHandle getCell(int row, int col)
		throws CellNotFoundException;
	...
	*/
	public abstract void moveCell(CellHandle c, String addr)
