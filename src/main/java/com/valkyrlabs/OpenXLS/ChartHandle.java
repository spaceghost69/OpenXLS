...
import com.valkyrlabs.formats.XLS.charts.Axis;
import com.valkyrlabs.formats.XLS.charts.Chart;
import com.valkyrlabs.formats.XLS.charts.ChartConstants;
import com.valkyrlabs.formats.XLS.charts.ChartType;
import com.valkyrlabs.formats.XLS.charts.OOXMLChart;
import com.valkyrlabs.formats.XLS.charts.Series;
import com.valkyrlabs.formats.XLS.charts.ThreeD;
import com.valkyrlabs.toolkit.Logger;

/**
 * Chart Handle allows for manipulation of Charts within a WorkBook. <br>
 ...
 * ChartHandle.createNewChart(sheet, charttype, chartoptions). <br>
 * <br>
 * To Obtain an array of existing chart handles, use <br>
...
public class ChartHandle implements ChartConstants {
	 ...
	 * each bar, line or wedge of data. <br>
	 * A chart number of 0 means the default chart, 1-9 indicate series for overlay
	 * charts <br>
	 * NOTE: using this method returns the series for the desired chart ONLY <br>
	 ...
	 * well
	 * <p>
	 * Note: The default scale setting for charts is known as Automatic Scaling <br>
	 ...
	 * well
	 * <p>
	 * Note: The default setting for charts is known as Automatic Scaling <br>
	 ...
	 * <p>
	 * The default setting for charts is known as Automatic Scaling <br>
	 ...
	 *                 one of: XAXIS, YAXIS, ZAXIS
	 * @param op
	 *                 option name; one of: CatCross, LabelCross, Marks,
	 *                 CrossBetween,
	 *                 CrossMax, MajorGridLines, AddArea, AreaFg, AreaBg or Linked
	 *                 Text
	 *                 Display options: Label, ShowKey, ShowValue, ShowLabelPct,
	 *                 ShowPct,
	 ...
	 * set the font for the Chart Title
	 * 
	 * @param com.valkyrlabs.Formats.XLS.Font
	 ...
	 * 
	 * @return com.valkyrlabs.Formats.XLS.Font
	 * @see Font
	 */
	 ...
	 * 
	 * @return com.valkyrlabs.Formats.XLS.Font for Chart Axes or null if no axes
	 * @see Font
	 */
	...
	/**
	 * returns the underlhying Sheet Object this Chart is attached to <br>
	 * For Internal Use
	 * 
	 * @return Boundsheet
	 */
	...
	/**
	 * Change the value of a Chart object. <br>
	 * <b>NOTE: THIS HAS NOT BEEN 100% IMPLEMENTED YET</b> <br>
	 ...
	 * 
	 * <br>
	 * To change the value of the Chart title <br>
	 * chart.changeObjectValue("Template Chart Title", "Widget Sales By Quarter");
	 * 
	 * <br>
	 * To change the text label of the categories <br>
	 * chart.changeObjectValue("Category X", "Fiscal Year");
	 * 
	 * <br>
	 * To change the text label of the values <br>
	...
	/**
	 * Sets the Chart type to the specified basic type (no 3d, no stacked ...) <br>
	 * To see possible Chart Types, view the public static int's in ChartHandle.
	 * <br>
	 * Possible Chart Types: <br>
	 * BARCHART <br>
	 * COLCHART <br>
	 * LINECHART <br>
	 * PIECHART <br>
	 ...
	 * stock SERLINES, bar, ofpie <br>
	 * Use these chart options when creating new charts <br>
	 ...
	 * chart Options options <br>
	 * After creating, you can set the chart title via ChartHandle.setTitle <br>
	 * and Position via ChartHandle.setRelativeBounds (row/col-based) or
	 * ChartHandle.setCoords (pixel-based) <br>
	...
	/**
	 * Sets the Chart type to the specified type (no 3d, no stacked ...) <br>
	 * To see possible Chart Types, view the public static int's in ChartHandle.
	 * <br>
	 * Possible Chart Types: <br>
	 * BARCHART <br>
	 ...
	 * @param EnumSet<ChartOptions>
	 *                              0 or more chart options (Such as Stacked,
	 *                              Exploded ...)
	 * @see ChartHandle.ChartOptions
	 */
	 ...
	 * and 1-9 are overlay charts. <br>
	 * The default chart (chart 0) is always present; however, using this method,
	 * you can create a new overlay chart (up to 9 maximum). <br>
	 * NOTE: The chart number must be <b>unique</b> and <b>in order</b> <br>
	 * If the desired chart number is not present in the chart, a new overlay chart
	 * will be created. <br>
	 * <b>To set explicit chart options, @see setChartType(chartType, nChart, is3d,
	 * isStacked, is100PercentStacked)</b> <br>
	 * <br>
	 * To see possible Chart Types, view the public static int's in ChartHandle.
	 * <br>
	 * Possible Chart Types: <br>
	 ...
	 * @param chartType
	 * @param nChart
	 *                  number and drawing order of the desired chart (default= 0
	 *                  max=9
	 *                  where 1-9 indicate an overlay chart)
	 */
	 ...
	 * <br>
	 * boolean changedOK =
	 * charthandle.changeSeriesRange("Sheet1!A1:A10","Sheet1!A1:A15"); <br>
	 * <br>
	 * Please keep in mind this is only the data range; it does not include labels
	 * that may have been automatically created when you chose the chart range. <br>
	 * <br>
	 ...
	 * 
	 * @param String
	 *               originalrange - the original Series (bar, line or wedge of
	 *               data)
	 *               to alter
	 * @param String
	...
	/**
	 * Change the Cell Range representing the Categories in the Chart. <br>
	 * Categories usually appear on the X Axis and are textual, not numeric <br>
	 * For example: the Category values in the Chart are obtained from the range
	 * Sheet1!A1:A10 and we want to add 5 more categories to the chart: <br>
	 * boolean changedOK =
	 * chart.changeCategoryRange("Sheet1!A1:A10","Sheet1!A1:A15"); <br>
	 ...
	 * wedge in a chart represents a Series. <br>
	 * If the Series index is greater than the number of series already present in
	 * the chart, the series will be added to the end. <br>
	 * Otherwise the Series at the index position will be altered. <br>
	 ...
	 *               already present in the chart, the series will be added to the
	 *               end
	 * @param String
	 *               legendCell - String representation of Legend Cell Address
	 * @param String
	 *               categoryRange - String representation of Category Range (should
	 *               be
	 *               same for all series)
	 * @param String
	 *               seriesRange - String representation of the Series Data Range
	 *               for
	 *               this series
	 * @param String
	 *               bubbleRange - String representation of Bubble Range
	 *               (representing
	 ...
	 * Series Index. Each bar, line or wedge in a chart represents a Series. <br>
	 * If the Series index is greater than the number of series already present in
	 * the chart, the series will be added to the end. <br>
	 * Otherwise the Series at the index position will be altered. <br>
	 * This method allows altering of every aspect of the Series: Data (Series)
	 ...
	 * @param String
	 *               categoryRange - Cell Range defining the category (normally will
	 *               be
	 *               the same range for all series)
	 * @param String
	 *               seriesRange - Cell range defining the data points of the series
	 * @param String
	 *               bubbleRange - Cell range defining the bubble sizes for this
	 *               series
	 *               (bubble charts only)
	 ...
	 * 
	 * @param String
	 *               legendCell - Cell reference for the legend cell (e.g.
	 *               Sheet1!A1)
	 * @param String
	 ...
	 * @param CellRange
	 *                   categoryRange - The CellRange referencing the category
	 *                   (should be
	 *                   the same for all Series)
	 * @param CelLRange
	 *                   seriesRange - The CellRange referencing the data points for
	 *                   one
	 *                   bar, line or wedge in the chart
	 * @param CellRange
	 *                   bubbleRange -The CellRange referencing bubble sizes for
	 *                   this
	...
	/**
	 * Adds a new Series to the chart via CellHandles and CellRange Objects. Each
	 * bar, line or wedge in a chart represents a Series. <br>
	...
	public ChartSeriesHandle addSeriesRange(CellHandle legendCell, CellRange categoryRange, CellRange seriesRange,
		...
		if (bubbleRange == null)
			s = mychart.addSeries(seriesRange.toString(), categoryRange
					.toString(), "",
					legendCell.getWorkSheetName() + "!"
							+ legendCell.getCellAddress(),
					legendCell
							.getStringVal(),
					nChart);
		else
	 ...
	 * 
	 * @param String[]
	 *                 valueRanges - Array of Cell Ranges representing the Values or
	 *                 Data
	 *                 points for each series (bar, line or wedge) on the Chart
	 * @param String[]
	 *                 legendCells - Array of Cell Addresses representing the
	 *                 legends for
	 *                 each Series
	 * @param String[]
	 *                 bubbleSizeRanges - Array of Cell ranges representing the
	 *                 bubble
	 ...
	 * updates (replaces) every Chart Series (bar, line or wedge on the Chart) with
	 * the data from the array of values, legends, bubble sizes (optional) and
	 * category range For the desired chart (0=default 1-9=overlay charts) <br>
	 * NOTE: all arrays must be the same size (the exception is the bubleSizeRanges
	 * array, which may be null)
	 * <p>
	 * NOTE: String arrays come in reverse order from plugins, so this method adds
	...
	/**
	 * Append a row of categories to the bottom of the chart. <br>
	 * Expands all Series to include the new bottom row. <br>
	 ...
	 * identifying the chart object. <br>
	 * this Drawing ML (OOXML) is distinct from Chart ML (OOXML) which actually
	 * defines the chart object including series, categories and axes <br>
	 * This is an internal method that is not useful to the end user.
	 * 
	 * @param int
	...
	public String getChartDrawingOOXML(int id) {
		...
		t.setAsChart(id, OOXMLAdapter.stripNonAscii(this.getOOXMLName())
				.toString(),
				TwoCellAnchor.convertBoundsFromBIFF8(this
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				if (eventType == XmlPullParser.START_TAG) {
					...
					if (tnm.equals("chart")) { // beginning of DrawingML for a
						...
						/**
						 * <sequence> 5
						 * <element name="title" type="CT_Title" minOccurs="0" maxOccurs="1"/> 6
						 * <element name="autoTitleDeleted" type="CT_Boolean" minOccurs="0" maxOccurs=
						 * "1"/> 7
						 * <element name="pivotFmts" type="CT_PivotFmts" minOccurs="0" maxOccurs="1"/> 8
						 * <element name="view3D" type="CT_View3D" minOccurs="0" maxOccurs="1"/> 9
						 * <element name="floor" type="CT_Surface" minOccurs="0" maxOccurs="1"/> 10
						 * <element name="sideWall" type="CT_Surface" minOccurs="0" maxOccurs="1"/> 11
						 * <element name="backWall" type="CT_Surface" minOccurs="0" maxOccurs="1"/> 12
						 ...
						 * dTable 13
						 * <element name="legend" type="CT_Legend" minOccurs="0" maxOccurs="1"/> 14
						...
						thischart.ooxmlLegend = (com.valkyrlabs.formats.OOXML.Legend) com.valkyrlabs.formats.OOXML.Legend
	...
	/**
	 * Specifies how to resize or move this Chart upon edit <br>
	 * This is an internal method that is not useful to the end user. <br>
	...
	/**
	 * returns the drawingml file name which defines the userShape (if any) <br>
	 ...
	 * a chart user shape, an image ... <br>
	 ...
	 * Possible Options:
	 * <p>
	 * "Stacked" - true or false - set Chart Series to be Stacked <br>
	 * "Cluster" - true or false - set Clustered for Column and Bar Chart Types <br>
	 ...
	 * (0 for all others) <br>
	 * "donutSize" - Donut size for Donut Charts Only <br>
	 * "Overlap" - Space between bars (default= 0%) <br>
	 * "Gap" - Space between categories (%) (default=50%) <br>
	 * "SmoothedLine" - true or false - the Line series has a smoothed line <br>
	 ...
	 * <br>
	 * "ThreeDScaling" - true or false - 3d effect <br>
	 * "TwoDWalls" - true if 2D walls (3D option) <br>
	 * "PcDist" - Distance from eye to chart (0 to 100) (30 is default) (3D option)
	 * <br>
	 * "ThreeDBubbles" - true or false - Draw bubbles with a 3d effect <br>
	 * "ShowLdrLines" - true or false - Show Pie and Donut charts Leader Lines <br>
	 * "MarkerFormat" - "0" thru "9" for various marker options @see
	 * ChartHandle.setMarkerFormat <br>
	 * "ShowLabel" - true or false - show Series/Data Label <br>
	 * "ShowCatLabel" - true or false - show Category Label <br>
	 * "ShowLabelPct" - true or false - show percentage labels for Pie charts <br>
	 ...
	 * <p>
	 * One of: <br>
	 * Axis.INVISIBLE - axis is hidden <br>
	 * Axis.LOW - low end of plot area <br>
	 * Axis.HIGH - high end of plot area <br>
	 ...
	 * <p>
	 * Possible options: <br>
	 * Axis.INVISIBLE - hides the axis <br>
	 * Axis.LOW - low end of plot area <br>
	 * Axis.HIGH - high end of plot area <br>
	 * Axis.NEXTTO- next to axis (default)
	 * 
	...
	/**
	 * Set non-axis chart font id for title, default, etc <br>
	 ...
	 * 
	 * @param short[8]
	 *                 bounds - COL, COLOFFSET, ROW, ROWOFFST, COL1, COLOFFSET1,
	 *                 ROW1,
	 *                 ROWOFFSET1
	 * 
	 */
	...
	/**
	 * makes this Chart Stacked <br>
	 * sets the group of options necessary to create a stacked chart <br>
	 * For Chart Types: <br>
	...
	/**
	 * makes this Chart 100% Stacked <br>
	 * sets the group of options necessary to create a 100% stacked chart <br>
	 * For Chart Types: <br>
	...
	/**
	 * makes this Chart Stacked with a 3D Effect <br>
	 * sets the group of options necessary to create a Stacked 3D chart <br>
	 * For Chart Types: <br>
	 * BAR, COL, AREA
	 * 
	 * @param nChart
	...
	/**
	 * makes this Chart 100% Stacked with a 3D Effect <br>
	 * sets the group of options necessary to create a 100% Stacked 3D chart <br>
	 * For Chart Types: <br>
	 * BAR, COL, AREA
	 * 
	 * @param nChart
	...
	/**
	 * makes the default Chart hava a 3D effect <br>
	 * sets the group of options necessary to create a 3D chart <br>
	 * For Chart Types: <br>
	...
	/**
	 * makes the desired Chart hava a 3D effect <br>
	 * where nChart 0= default, 1-9=multiple charts in one <br>
	 * sets the group of options necessary to create a 3D chart <br>
	 * For Chart Types: <br>
	 * BARCHART, COLCHART, LINECHART, PIECHART, AREACHART, BUBBLECHART,
	 * PYRAMIDCHART, CYLINDERCHART, CONECHART
	...
	/**
	 * makes this Chart Clusted with a 3D effect <br>
	 * sets the group of options necessary to create a Clusted 3D chart <br>
	 * For Chart Types: <br>
	 * BAR, COL
	 * 
	 * @param nChart
	...
	/**
	 * makes this chart's wedges exploded i.e. separated <br>
	 * For Chart Types: <br>
	...
	/**
	 * makes this chart's wedges exploded 3D i.e. separated with a 3D effect <br>
	 * For Chart Types: <br>
	 * PIECHART, DOUGHNUTCHART
	 * 
	 * @param nChart
	...
	/**
	 * set the marker format style for this chart <br>
	 * one of: <br>
	 * 0 = no marker <br>
	 * 1 = square <br>
	 * 2 = diamond <br>
	...
	/**
	 * utility to add a JSON object <br>
	 * This is an internal method that is not useful to the end user.
	 * 
	 * @param source
	 * @param input
	...
	/**
	 * retrieves the saved Series JSON for comparisons <br>
	 * This is an internal method that is not useful to the end user.
	 * 
	 * @return JSONArray
	 */
	...
	public String getSVG(double scale) {
		 ...
		 * "c:/eclipse/workspace/testfiles/com.valkyrlabs.OpenXLS/output/charts/FromSheetster.svg"
