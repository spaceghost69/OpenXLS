...
public class CellRange implements Serializable {
	...
	protected transient com.valkyrlabs.OpenXLS.WorkBook mybook;
	 ...
	 *                                  if the source range does not have a resolved
	 *                                  sheet or has more
	 *                                  than one sheet
	 */
	 ...
	 * 
	 * @param boolean
	 *                remove - true to delete the Cells following the first in the
	 *                range
	 */
	 ...
	 *                        sht - handle to the WorkSheet containing the Range's
	 *                        Cells
	 * @param int[]
	 ...
	 */
	public CellRange(String range, com.valkyrlabs.OpenXLS.WorkBook bk, boolean createblanks, boolean initcells) {
	 ...
	 *                 necessary)
	 */
	public CellRange(String range, com.valkyrlabs.OpenXLS.WorkBook bk, boolean c) {
		createBlanks = c;
		this.range = range;
		if (bk == null)
			return;
	 ...
	 * 
	 * @param CellHandle[]
	 *                     newcells - the array of cells from which to create the
	 *                     new
	 *                     CellRange
	 ...
	 *                     CellRange
	 * @param boolean
	 *                     createblanks - true if should create blank cells if
	 *                     necesary
	 */
	 ...
	 * @throws CellNotFoundException
	 */
	public CellRange(String range, com.valkyrlabs.OpenXLS.WorkBook bk) throws CellNotFoundException {
		this(range, bk, true);
	}
	 ...
	 *                 bk
	 */
	public void setWorkBook(com.valkyrlabs.OpenXLS.WorkBook bk) {
		this.mybook = bk;
	}
	...
	public void init() throws CellNotFoundException {
		if (!FormulaParser.isComplexRange(range)) {
			...
			int rowctr = coords[0];
			firstcellcol = coords[1];
			lastcellcol = coords[3];
			...
			com.valkyrlabs.formats.XLS.formulas.PtgMemFunc pm = new com.valkyrlabs.formats.XLS.formulas.PtgMemFunc();
	 ...
	 * 
	 * @param createBlanks
	 *                     whether missing cells should be created as blanks. If
	 *                     this is
	 ...
	 * 
	 * @param source
	 *                  the cell whose attributes should be copied or
	 *                  <code>null</code> to
