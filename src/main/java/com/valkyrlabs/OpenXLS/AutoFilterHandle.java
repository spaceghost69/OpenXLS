...
public class AutoFilterHandle implements Handle {
	 ...
	 * String operator and an Object value <br>
	 * This method sets the second condition of a two-condition filter
	 * <p>
	 * Only those rows that meet the equation: <br>
	 * first condition AND/OR (column value) OP value will be shown <br>
	...
	/**
	 * Sets this AutoFilter to be a Top-n or Bottom-n type of filter <br>
	 * Top-n filters only show the Top n values or percent in the column <br>
