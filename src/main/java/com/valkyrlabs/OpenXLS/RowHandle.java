...
import static com.valkyrlabs.OpenXLS.JSONConstants.JSON_HEIGHT;
import static com.valkyrlabs.OpenXLS.JSONConstants.JSON_ROW;
import static com.valkyrlabs.OpenXLS.JSONConstants.JSON_ROW_BORDER_BOTTOM;
import static com.valkyrlabs.OpenXLS.JSONConstants.JSON_ROW_BORDER_TOP;
    ...
    public boolean containsVerticalMergeRange() {
        ...
        for (int i=0;i<c.length;i++) {
            if (c[i].getMergedCellRange()!=null) {
                ...
                try {
                    if (cr.getRows().length>1)return true;
                }catch (Exception e) {};
            }
        }
        return false;
...
*/
	...
	*/
	 ...
	 * @return
	 */
	public int[] getColDimensions() { return myRow.getColDimensions(); }
