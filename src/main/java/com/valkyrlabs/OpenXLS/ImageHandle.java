...
/** The ImageHandle provides access to an Image embedded in a spreadsheet.<br>
    ...
    @see com.valkyrlabs.OpenXLS.WorkBookHandle
    @see com.valkyrlabs.OpenXLS.WorkSheetHandle
*/
public class ImageHandle implements Serializable{
    ...
    public String getType() {
    	switch(image_type) {
	    	case com.valkyrlabs.formats.XLS.MSODrawingConstants.IMAGE_TYPE_GIF:
	    		return "gif";
	    	case com.valkyrlabs.formats.XLS.MSODrawingConstants.IMAGE_TYPE_JPG:
	    		return "jpeg";
	    	case com.valkyrlabs.formats.XLS.MSODrawingConstants.IMAGE_TYPE_PNG:
	    		return "png";
	    	case com.valkyrlabs.formats.XLS.MSODrawingConstants.IMAGE_TYPE_EMF:
	    		return "emf";
	    	default:
	    		return "undefined";
    	}
    ...
    public String getXML(int rId) {
 	StringBuffer sb= new StringBuffer();
    	...
    	sb.append("<twoCellAnchor editAs=\"oneCell\">");	sb.append("\r\n");
    		// top left coords 
    		sb.append("<from>");
    		...
    		sb.append("<pic>");		sb.append("\r\n");
    	        ...
    	        sb.append("</spPr>");
    	    sb.append("</pic>");	sb.append("\r\n");
    	    sb.append("<clientData/>");	sb.append("\r\n");
