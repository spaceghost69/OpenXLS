...
public class ValidationHandle implements Handle {
	...
	public static String[] CONDITIONS = { "between", "notBetween", "equal",
			"notEqual", "greaterThan", "lessThan", "greaterOrEqual",
			"lessOrEqual" };
	...
	public static String[] VALUE_TYPE = { "any", "integer", "decimal",
			"userDefinedList", "date", "time", "textLength", "formula" };
	 ...
	 * @return
	 */
	public boolean isValid(Object value, boolean throwException)
	 ...
	 * 
	 * @param range
	 *            = standard excel range without worksheet information ("A1" or
	 *            "A1:A10")
	 */
	 ...
	 * 
	 * @param firstCond
	 *            = the first condition for the validation
	 */
	...
	public String getXML() {
		...
		xml.append(" showInputMessage=\""
				+ ((this.getShowInputMsg()) ? "1" : "0") + "\"");
		xml.append(" showErrorMessage=\""
				+ ((this.isShowErrorMsg()) ? "1" : "0") + "\"");
