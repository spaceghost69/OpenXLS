...
public class CellRangeRef implements Cloneable {
	 ...
	 */
	public static CellRangeRef fromA1(String reference, WorkBookHandle book) throws SheetNotFoundException {
	 ...
	 *                                if either of the sheets does not exist in the
	 *                                given book
	 */
	public void resolve(WorkBookHandle book) throws SheetNotFoundException {
	...
	/**
	 * Compares this range to the specified object. The result is <code>true</code>
	 * if and only if the argument is not <code>null</code> and is a
	 * <code>CellRangeRef</code> object that represents the same range as this
	 * object.
	 */
	@Override
