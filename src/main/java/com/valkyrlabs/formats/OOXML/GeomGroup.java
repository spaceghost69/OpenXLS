...
public class GeomGroup implements OOXMLElement {
    ...
    public String getOOXML() {
        ...
        if (this.p != null) ooxml.append(p.getOOXML());
        else if (this.c != null) ooxml.append(c.getOOXML());
...
class PrstGeom implements OOXMLElement {
    ...
    public PrstGeom() {    // no-param constructor, set up common defaults
        prst = "rect";
        avLst = new AvLst();
    }
    ...
    public static PrstGeom parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("prstGeom")) {        // get attributes
    ...
    public String getOOXML() {
        ...
        if (avLst != null) ooxml.append(avLst.getOOXML());
...
class CustGeom implements OOXMLElement {
    ...
    private final PathLst pathLst;
    private final GdLst gdLst;
    private final AvLst avLst;
    private final CxnLst cxnLst;
    ...
    public String getOOXML() {
        ...
        if (avLst != null) ooxml.append(avLst.getOOXML());    // avLst
        if (gdLst != null) ooxml.append(gdLst.getOOXML());    // gdLst
        // TODO: ahLst
        ooxml.append("<a:ahLst/>");
        if (cxnLst != null) ooxml.append(cxnLst.getOOXML());    // cxnLst
        if (rect != null) ooxml.append(rect.getOOXML());    // rect
        if (pathLst != null) ooxml.append(pathLst.getOOXML());    // pathLst
        ooxml.append("</a:custGeom>");
        return ooxml.toString();
    }
    ...
    public static PathLst parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("pathLst")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++)
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                    } else if (tnm.equals("path")) {        // get one or more path children
                        lastTag.push(tnm);
    ...
    public String getOOXML() {
        ...
        if (path != null) {
            for (int i = 0; i < path.size(); i++)
                ooxml.append(path.get(i).getOOXML());
        }
        ooxml.append("</a:pathLst>");
        return ooxml.toString();
    }
    ...
    public static Path parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("path")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
...
class GdLst implements OOXMLElement {
    ...
    private final ArrayList<Gd> gds;
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("gd")) {
                        lastTag.push(tnm);
                        if (gds == null) gds = new ArrayList<Gd>();
    ...
    public String getOOXML() {
        ...
        if (gds != null) {
            for (int i = 0; i < gds.size(); i++)
                ooxml.append(gds.get(i).getOOXML());
        }
        ooxml.append("</a:gdLst>");
        return ooxml.toString();
    }
    ...
    public static Rect parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("rect")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
...
class CxnLst implements OOXMLElement {
    ...
    private final ArrayList<Cxn> cxns;
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("cxn")) {
                        lastTag.push(tnm);
                        if (cxns == null) cxns = new ArrayList<Cxn>();
    ...
    public String getOOXML() {
        ...
        if (cxns != null) {
            for (int i = 0; i < cxns.size(); i++)
                ooxml.append(cxns.get(i).getOOXML());
        }
        ooxml.append("</a:cxnLst>");
        return ooxml.toString();
    }
...
class Cxn implements OOXMLElement {
    ...
    public static Cxn parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("cxn")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
    ...
    public String getOOXML() {
        ...
        ooxml.append(">");
        if (pos != null) ooxml.append(pos.getOOXML());
        ooxml.append("</a:cxn>");
        return ooxml.toString();
    }
    ...
    public static Pos parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("pos")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
                    }
