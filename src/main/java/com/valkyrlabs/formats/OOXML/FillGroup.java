...
public class FillGroup implements OOXMLElement {
    ...
    public FillGroup(BlipFill bf, GradFill gpf, GrpFill grpf, PattFill pf,
                     SolidFill sf) {
        this.bf = bf;
        this.gpf = gpf;
        this.grpf = grpf;
...
class GradFill implements OOXMLElement {
    ...
    private final GsLst g;
    // private ShadeProps sp= null;
    private final TileRect tr;
    ...
    public static GradFill parseOOXML(XmlPullParser xpp, Stack<String> lastTag, WorkBookHandle bk) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("gradFill")) { // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp
                                    .getAttributeValue(i));
                        }
...
class BlipFill implements OOXMLElement {
    ...
    public BlipFill() {    // no-parameter constructor, set common defaults
        srcRect = new SrcRect();
    ...
    public static BlipFill parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("blipFill")) { // get attributes
                        ns = xpp.getPrefix();
                        for (int i = 0; i < xpp.getAttributeCount(); i++)
                            attrs.put(xpp.getAttributeName(i), xpp
                                    .getAttributeValue(i));
...
class SolidFill implements OOXMLElement {
    ...
    public SolidFill() { // no-param constructor, set up common defaults
    ...
    public static SolidFill parseOOXML(XmlPullParser xpp, Stack<String> lastTag, WorkBookHandle bk) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("hslClr") || tnm.equals("prstClr")
                            || tnm.equals("schemeClr")
                            || tnm.equals("scrgbClr") || tnm.equals("srgbClr")
                            || tnm.equals("sysClr")) { // get attributes
                        lastTag.push(tnm);
...
class PattFill implements OOXMLElement {
    ...
    private final String prst;
    private final BgClr bg;
    private final FgClr fg;
    ...
    public static PattFill parseOOXML(XmlPullParser xpp, Stack<String> lastTag, WorkBookHandle bk) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("pattFill")) { // get attributes
    ...
    public static Blip parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("blip")) { // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            if (xpp.getAttributePrefix(i) != null)
                                attrs.put(xpp.getAttributePrefix(i) + ":"
    ...
    public static TileRect parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("tileRect")) { // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++)
                            attrs.put(xpp.getAttributeName(i), xpp
                                    .getAttributeValue(i));
                    }
    ...
    public static SrcRect parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("srcRect")) { // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp
                                    .getAttributeValue(i));
                        }
    ...
    public static FillRect parseOOXML(XmlPullParser xpp, Stack<?> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("fillRect")) { // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++)
                            attrs.put(xpp.getAttributeName(i), xpp
                                    .getAttributeValue(i));
                    }
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    } else if (tnm.equals("fillRect")) { // only child of
                        // stretch
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp
                                    .getAttributeValue(i));
    ...
    public String getOOXML() {
        ...
        if (!gs.isEmpty()) {
            ...
            for (int i = 0; i < gs.size(); i++) {
                ooxml.append(gs.get(i).getOOXML());
            }
            ooxml.append("</a:gsLst>");
        } else
            ooxml.append("/>");
    ...
    public static Gs parseOOXML(XmlPullParser xpp, Stack<String> lastTag, WorkBookHandle bk) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("gs")) { // get attributes
                        pos = xpp.getAttributeValue(0);
                    } else if (tnm.equals("hslClr") || tnm.equals("prstClr")
                            || tnm.equals("schemeClr")
                            || tnm.equals("scrgbClr") || tnm.equals("srgbClr")
                            || tnm.equals("sysClr")) { // get attributes
                        lastTag.push(tnm);
