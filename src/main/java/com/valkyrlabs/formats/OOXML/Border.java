...
public class Border implements OOXMLElement {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("border")) {        // get attributes
    ...
    public String getOOXML() {
        ...
        ooxml.append(">");
        if (borderElements.get("left") != null) ooxml.append(borderElements.get("left").getOOXML());
        if (borderElements.get("right") != null) ooxml.append(borderElements.get("right").getOOXML());
        if (borderElements.get("top") != null) ooxml.append(borderElements.get("top").getOOXML());
        if (borderElements.get("bottom") != null) ooxml.append(borderElements.get("bottom").getOOXML());
        if (borderElements.get("diagonal") != null) ooxml.append(borderElements.get("diagonal").getOOXML());
        if (borderElements.get("vertical") != null) ooxml.append(borderElements.get("vertical").getOOXML());
        if (borderElements.get("horizontal") != null) ooxml.append(borderElements.get("horizontal").getOOXML());
    ...
    public int[] getBorderSizes() {
        int[] sizes = new int[5];
        if (borderElements.get("top") != null) sizes[0] = borderElements.get("top").getBorderSize();
        if (borderElements.get("left") != null) sizes[1] = borderElements.get("left").getBorderSize();
        if (borderElements.get("bottom") != null) sizes[2] = borderElements.get("bottom").getBorderSize();
        if (borderElements.get("right") != null) sizes[3] = borderElements.get("right").getBorderSize();
        if (borderElements.get("diagonal") != null) sizes[4] = borderElements.get("diagonal").getBorderSize();
        return sizes;
    }
    ...
    public int[] getBorderStyles() {
        ...
        if (borderElements.get("top") != null) styles[0] = borderElements.get("top").getBorderStyle();
        if (borderElements.get("left") != null) styles[1] = borderElements.get("left").getBorderStyle();
        if (borderElements.get("bottom") != null) styles[2] = borderElements.get("bottom").getBorderStyle();
        if (borderElements.get("right") != null) styles[3] = borderElements.get("right").getBorderStyle();
        if (borderElements.get("diagonal") != null) styles[4] = borderElements.get("diagonal").getBorderStyle();
        return styles;
    }
    ...
    public String[] getBorderColors() {
        try {
            ...
            if (borderElements.get("top") != null) clrs[0] = borderElements.get("top").getBorderColor();
            if (borderElements.get("left") != null) clrs[1] = borderElements.get("left").getBorderColor();
            if (borderElements.get("bottom") != null) clrs[2] = borderElements.get("bottom").getBorderColor();
            if (borderElements.get("right") != null) clrs[3] = borderElements.get("right").getBorderColor();
            if (borderElements.get("diagonal") != null) clrs[4] = borderElements.get("diagonal").getBorderColor();
            return clrs;
    ...
    public int[] getBorderColorInts() {
        try {
            int[] clrs = new int[5];
            if (borderElements.get("top") != null) clrs[0] = borderElements.get("top").getBorderColorInt();
            if (borderElements.get("left") != null) clrs[1] = borderElements.get("left").getBorderColorInt();
            if (borderElements.get("bottom") != null) clrs[2] = borderElements.get("bottom").getBorderColorInt();
            if (borderElements.get("right") != null) clrs[3] = borderElements.get("right").getBorderColorInt();
            if (borderElements.get("diagonal") != null) clrs[4] = borderElements.get("diagonal").getBorderColorInt();
            return clrs;
        } catch (NullPointerException e) {
            return new int[5];
        }
...
class BorderElement implements OOXMLElement {
    ...
    private Color color;
    private final String borderElement;
    ...
    public BorderElement(String style, int val, String borderElement, WorkBookHandle bk) {
        this.style = style;
        if (style != null && val != -1)
            this.color = new Color("color", false, Color.COLORTYPEINDEXED, String.valueOf(val), 0.0, (short) 0, bk.getWorkBook().getTheme());
        this.borderElement = borderElement;
    }
    ...
    public String getOOXML() {
        ...
        if (style != null) {
            ...
            if (color != null) ooxml.append(color.getOOXML());
            ooxml.append("</" + borderElement + ">");
        } else
            ooxml.append("/>");
        return ooxml.toString();
