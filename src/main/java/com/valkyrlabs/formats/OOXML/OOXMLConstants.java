...
public interface OOXMLConstants {
    ...
    String pkgrelns = "http://schemas.openxmlformats.org/package/2006/relationships";    // .rels ns
    String relns = "http://schemas.openxmlformats.org/officeDocument/2006/relationships";
    String typens = "http://schemas.openxmlformats.org/package/2006/content-types";
    String drawingns = "http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing";
    String drawingmlns = "http://schemas.openxmlformats.org/drawingml/2006/main";
    String chartns = "http://schemas.openxmlformats.org/drawingml/2006/chart";
    String drawingDir = "xl/drawings";
    String mediaDir = "xl/media";
    String chartDir = "xl/charts";
    String themeDir = "xl/theme";
    ...
    String[][] contentTypes = {
            ...
            {"image", "image"}, // images don't go into Content_Types
