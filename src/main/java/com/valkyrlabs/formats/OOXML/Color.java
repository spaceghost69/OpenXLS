...
public class Color implements OOXMLElement {
    ...
    private int colorint = -1;        // parsed color (tint + value) translated to OpenXLS color int value
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("color") ||
                            tnm.equals("fgColor") ||
                            tnm.equals("bgColor")) {        // get attributes
...
//		c.parseColor(type);
    ...
    public static Object[] parseThemeColor(String colorval, double tint, short type, Theme t) {
        ...
        } catch (Exception e) {        // OpenXLS-created xlsx files will not have theme entries
    ...
    public String getOOXML() {
        ...
        if (this.auto) ooxml.append(" auto=\"1\"");
