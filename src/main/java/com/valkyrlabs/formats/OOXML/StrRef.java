...
public class StrRef implements OOXMLElement {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("f")) {
                        f = com.valkyrlabs.formats.XLS.OOXMLAdapter.getNextText(xpp);
    ...
    public String getOOXML() {
        ...
        if (this.strCache != null) tooxml.append(strCache.getOOXML());
        tooxml.append("</c:strRef>");
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("ptCount")) {
                        ...
                        pt = com.valkyrlabs.formats.XLS.OOXMLAdapter.getNextText(xpp);
                    }
                } else if (eventType == XmlPullParser.END_TAG) {
                    String endTag = xpp.getName();
