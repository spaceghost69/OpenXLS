...
public class Legend implements OOXMLElement {
    ...
    private final String legendpos;    // actually an element but only contains 1 attribute: val
    private final LegendEntry le;
    private final Layout layout;
    private final SpPr shapeProps;                    // defines the shape properties for the legend for this chart
    private final TxPr txpr;                        // defines text properties
     ...
     * @param l
     */
    public static Legend createLegend(com.valkyrlabs.formats.XLS.charts.Legend l) {
     ...
     * @param l_2003
     */
    public void fill2003Legend(com.valkyrlabs.formats.XLS.charts.Legend l_2003) {
    ...
    public String getOOXML() {
        ...
        if (le != null) ooxml.append(le.getOOXML());
        if (layout != null) ooxml.append(layout.getOOXML());
        if (overlay != null) ooxml.append("<c:overlay val=\"" + overlay + "\"/>");
        if (shapeProps != null) ooxml.append(shapeProps.getOOXML());
        if (txpr != null) ooxml.append(txpr.getOOXML());
        ooxml.append("</c:legend>");
...
class LegendEntry implements OOXMLElement {
    ...
    public String getOOXML() {
        ...
        if (tx != null) tooxml.append(tx.getOOXML());
        tooxml.append("</c:legendEntry>");
