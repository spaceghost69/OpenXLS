...
public class BodyPr implements OOXMLElement {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("bodyPr")) {        // body text properties
                    ...
                    } else if (tnm.equals("spAutoFit")) {    // TODO: should be a choice of autofit options
    ...
    public String getOOXML() {
        ...
        ooxml.append(">");
        if (txwarp != null) ooxml.append(txwarp.getOOXML());
        if (spAutoFit) ooxml.append("<a:spAutoFit/>");        // TODO: Should be a choice of autofit options
        // scene3d
        // text3d choice
        ooxml.append("</a:bodyPr>");
...
class PrstTxWarp implements OOXMLElement {
    ...
    public static PrstTxWarp parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("prstTxWarp")) {        // prst is only attribute and is required
    ...
    public String getOOXML() {
        ...
        if (av != null) ooxml.append(av.getOOXML());
