        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("autoFilter")) {        // get ref attribute
                        if (xpp.getAttributeCount() == 1) ref = xpp.getAttributeValue(0);
                    } else if (tnm.equals("sortState")) {
                    } else if (tnm.equals("filterColumn")) {
                        if (f == null) f = new ArrayList<FilterColumn>();
    ...
    public String getOOXML() {
        ...
        if (filterColumns != null) {
            for (int i = 0; i < filterColumns.size(); i++)
                ooxml.append(filterColumns.get(i).getOOXML());
        }
        ooxml.append("</autoFilter>");
...
class FilterColumn implements OOXMLElement {
    ...
    public static FilterColumn parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("filterColumn")) {        // get attributes
    ...
    public String getOOXML() {
        ...
        ooxml.append(">");
        if (filter instanceof ColorFilter) ooxml.append(((ColorFilter) filter).getOOXML());
        if (filter instanceof CustomFilters) ooxml.append(((CustomFilters) filter).getOOXML());
        if (filter instanceof DynamicFilter) ooxml.append(((DynamicFilter) filter).getOOXML());
        if (filter instanceof Filters) ooxml.append(((Filters) filter).getOOXML());
        if (filter instanceof IconFilter) ooxml.append(((IconFilter) filter).getOOXML());
        if (filter instanceof Top10) ooxml.append(((Top10) filter).getOOXML());
        ooxml.append("</filterColumn>");
        return ooxml.toString();
    }
    ...
    public static ColorFilter parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("colorFilter")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
                    }
    ...
    public static DynamicFilter parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("dynamicFilter")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
                    }
    ...
    public static IconFilter parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("iconFilter")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
                    }
...
class CustomFilters implements OOXMLElement {
    ...
    public static CustomFilters parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("customFilters")) {        // get attributes
                        if (xpp.getAttributeCount() == 1) and = (xpp.getAttributeValue(0).equals("1"));
                    } else if (tnm.equals("customFilter")) {    // 1-2
    ...
    public String getOOXML() {
        ...
        ooxml.append(">");
        if (custfilter != null) {    // shouln't be!
            if (custfilter[0] != null)// shouldn't be!
                ooxml.append(custfilter[0].getOOXML());
            if (custfilter[1] != null) ooxml.append(custfilter[1].getOOXML());
        }
        ooxml.append("</customFilters>");
        return ooxml.toString();
    }
    ...
    public static CustomFilter parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("customFilter")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
                    }
    ...
    public static Top10 parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("top10")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
                    }
    ...
    public static Filters parseOOXML(XmlPullParser xpp) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("filters")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            attrs.put(xpp.getAttributeName(i), xpp.getAttributeValue(i));
                        }
