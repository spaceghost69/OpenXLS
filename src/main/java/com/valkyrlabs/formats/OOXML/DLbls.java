...
public class DLbls implements OOXMLElement {
    ...
    public DLbls(int showVal, int showLeaderLines, int showLegendKey, int showCatName,
                 int showSerName, int showPercent, int showBubbleSize, SpPr sp, TxPr tx) {
    ...
    public DLbls(boolean showVal, boolean showLeaderLines, boolean showLegendKey, boolean showCatName,
                 boolean showSerName, boolean showPercent, boolean showBubbleSize, SpPr sp, TxPr tx) {
...
//	        			 sp.setNS("c");
        ...
        DLbls d = new DLbls(showVal, showLeaderLines, showLegendKey, showCatName, showSerName,
    ...
    public String getOOXML() {
        ...
        if (tx != null) ooxml.append(tx.getOOXML());
        // TODO: dLblPos
