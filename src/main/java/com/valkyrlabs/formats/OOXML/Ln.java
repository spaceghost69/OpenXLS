...
public class Ln implements OOXMLElement {
    ...
    public Ln() {    // no-param constructor, set up common defaults
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("ln")) {        // get ln attributes
    ...
    public String getOOXML() {
        ...
        ooxml.append(">");
        if (fill != null) ooxml.append(fill.getOOXML());
        if (dash != null) ooxml.append(dash.getOOXML());
        if (join != null) ooxml.append(join.getOOXML());
        if (h != null) ooxml.append(h.getOOXML());
        if (t != null) ooxml.append(t.getOOXML());
        ooxml.append("</a:ln>");
    ...
    public int getLineStyle() {
        if (dash != null) {
            ...
            if (style.equals("solid"))
                ...
                return 3;
            else if (style.equals("sysDashDashDot") ||
                    style.equals("lgDashDotDot"))
                return 4;
        }
        // ? none = 5 ???
        return 0;    // solid
...
class DashGroup implements OOXMLElement {
    ...
    private final PrstDash prstDash;
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    String endTag = xpp.getName();
                    if (endTag.equals("custDash") ||
                            endTag.equals("prstDash")) {
                        lastTag.pop();
                        break;
                    }
                }
    ...
    public String getOOXML() {
        StringBuffer ooxml = new StringBuffer();
        if (prstDash != null) ooxml.append(prstDash.getOOXML());
        // TODO: finish custDash
        return ooxml.toString();
    }
...
class JoinGroup implements OOXMLElement {
    ...
    private final boolean miter;
    private final boolean round;
    private final boolean bevel;
    private final String miterVal;
    ...
    public static HeadEnd parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("headEnd")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
    ...
    public static TailEnd parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("tailEnd")) {        // get attributes
                        for (int i = 0; i < xpp.getAttributeCount(); i++) {
                            String n = xpp.getAttributeName(i);
                            if (n.equals("len"))
                                len = xpp.getAttributeValue(i);
    ...
    public static PrstDash parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("prstDash")) {        // get val attribute
