...
public class Pic implements OOXMLElement {
    ...
    private final BlipFill blipFill;
    private SpPr spPr;
    private Style style;

    public Pic() {        // set common defaults
        nvPicPr = new NvPicPr();
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tnm.equals("pic")) {        // get attributes
    ...
    public String getOOXML() {
        ...
        ooxml.append(">");
        if (nvPicPr != null) ooxml.append(nvPicPr.getOOXML());
        if (blipFill != null) ooxml.append(blipFill.getOOXML());
        if (spPr != null) ooxml.append(spPr.getOOXML());
        if (style != null) ooxml.append(style.getOOXML());
        ooxml.append("</xdr:pic>");
...
class NvPicPr implements OOXMLElement {
    ...
    private final CNvPr cpr;
    private final CNvPicPr ppr;

    public NvPicPr() {    // set common defaults
        this.cpr = new CNvPr();
    ...
    public static CNvPicPr parseOOXML(XmlPullParser xpp, Stack<String> lastTag) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.START_TAG) {
                    String tnm = xpp.getName();
                    if (tnm.equals("cNvPicPr")) {        // get attributes
