...
public class SXString extends XLSRecord implements XLSConstants, PivotCacheRecord{
	...
	*/
	...
	public String toString() { return "SXString: " + ((segment!=null)?segment:"null") + 
	   ...
	   public void setCacheItem(String s) {
		   ...
		   byte[] strbytes= new byte[0];
			if (segment!=null) {
			    ...
			    }catch(UnsupportedEncodingException e){Logger.logInfo("SxString: " + e);}
			}
...
// 	 (byte[]) [5, 0, 0, 115, 111, 117, 116, 104]	south		   
	   ...
	   public String getCacheItem() { return segment; }
	   /**
