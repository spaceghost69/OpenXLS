 ...
 */
public final class Obj extends com.valkyrlabs.formats.XLS.XLSRecord {
    // OBJECT TYPES
...
*/
        ...
        switch (obType) {
            ...
            case otDropdownlist:
                ...
                ftSbs.parse(new byte[]{12, 0, 20, 0,
                        0, 0, 0, 0,    /* unused */
                        0, 0,        /* iVal */
                        0, 0,        /* iMin */
                        100, 0,        /* iMax */
    ...
    public void init() {
        ...
        try {    // parse rest of object sub-records
            int pos = 22;
            int cb;
    ...
    private class FtLbsData extends SubRecord {
        ...
        public void parse(byte[] rec, int pos, boolean isListBox) {
            ...
            if (cbFContinued != 0) {
                ...
                // bits 7, 8 - ignore
                // lct			8 bits
                if ((grbit & 0x1) == 0x1) { // fUseCB means lct is valid
