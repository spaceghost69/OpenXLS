...
/*
   Unhandled or Unimplemented PTG, that is stored as a 1 byte ptg.  Eases ability
   to reconstruct these formulas
...
public class PtgMystery extends GenericPtg implements Ptg {
    ...
    // KSC: Using PtgMystery as a Generic, lightweight Ptg

    /**
     * Holder for PtgMemFunc/Area components
