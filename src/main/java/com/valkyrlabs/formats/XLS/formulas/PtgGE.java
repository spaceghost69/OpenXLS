...
/*
  Ptg that is a Greater than or equal to operand
   
   Evaluates to TRUE if the second operand is greater than or equal
...
*/
public class PtgGE extends GenericPtg implements Ptg {
    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = 5154662904662222256L;
