 ...
 */
        ...
        if (parent_rec != null && parent_rec instanceof Shrfmla) {
            ...
            lastPtgN.setFormulaRow(parent_rec.getLastRow());
            lastPtgN.setFormulaCol(parent_rec.getLastCol());
        }
...
//        	this.addToRefTracker();
    ...
    public PtgArea convertToPtgArea(com.valkyrlabs.formats.XLS.XLSRecord r) {
