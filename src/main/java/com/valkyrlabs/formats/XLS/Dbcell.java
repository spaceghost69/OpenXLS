 ...
 * <b>Dbcell: Stream Offsets 0xD7</b><br>
   ...
   @see XLSRecord
 */
public final class Dbcell extends com.valkyrlabs.formats.XLS.XLSRecord implements XLSConstants{
    ...
    */
    public void setIndex(Index idx){myidx = idx;}
    ...
    */
    void setDBCNum(int l){dbcnum = l;}
    /** get the DBCELL number for use by the Index
    */
    int getDBCNum(){return dbcnum;}
    ...
    */    
    public Index getIDX(){return myidx;}
     ...
     */
 	public void init(){
        ...
        //     Logger.logInfo("DBCELL POINTER at: " + String.valueOf(dbRtrw));
             for(int t = 0;t<rgdb.length;t++){Logger.logInfo(" rgdb" + t + ":" + String.valueOf(rgdb[t]));}
             Logger.logInfo(" num idxs: " + String.valueOf(numrecs));
         }
     }
