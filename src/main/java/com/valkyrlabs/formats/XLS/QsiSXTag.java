...
public class QsiSXTag extends XLSRecord implements XLSConstants {
	...
	public void init() {
        ...
        if (cchName>0) {
            ...
            }catch(UnsupportedEncodingException e){Logger.logInfo("encoding PivotTable name in QxiSXTag: " + e);}
        }
		if (DEBUGLEVEL > 3) Logger.logInfo("QXISXTAG-" + " flags:" + flags + " verLast:" + verSxLastUpdated + " verMin:" + verSxUpdatableMin + " name:" + name);
	} 
	...
	public void setName(String name) {
		...
		if (name!=null) {
	        ...
	        }catch(UnsupportedEncodingException e){Logger.logInfo("encoding pivot table name in SXVI: " + e);}
