...
public class Writeaccess extends com.valkyrlabs.formats.XLS.XLSRecord
{
    /** 
	* serialVersionUID
	*/
    ...
    */
    public void setName(String str){
        try{
            ...
            if(diff < 0)System.arraycopy(nameb, 0, newb, 0, 112);
            else System.arraycopy(nameb, 0, newb, 0, nameb.length);
            strname.init(newb,false);
            this.setData(newb);
        }catch(UnsupportedEncodingException e){Logger.logInfo("setting name in Writeaccess record failed: " + e);}
    }
