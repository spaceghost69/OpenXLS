...
import com.valkyrlabs.formats.XLS.SxAddl.ADDL_CLASSES;
...
public class SXFDBType extends XLSRecord implements XLSConstants, PivotCacheRecord{
	...
	*/
	enum ODBCType {
		SQL_TYPE_NULL(0), /** Undetermined type, data source (1) does not support typed data. Data type determined based on data content: date and time, decimal or text.*/
		SQL_CHAR(1),	  /** Fixed-length string of ANSI characters */
		SQL_DECIMAL(3),   /** Fixed-precision, Fixed-scale numbers */	
		SQL_INTEGER(4),   /** 32-bit signed integer */
		SQL_SMALLINT(5),  /** 16-bit signed integer*/	
		SQL_FLOAT(6),	  /** User-specified precision floating-point */
		SQL_REAL(7),	  /** 7-digits precision floating-point */
		SQL_DOUBLE(8),	  /** 15-digits precision floating-point */
		SQL_TIMESTAMP(0xB),	/** Date and Time */
		SQL_VARCHAR(0xC), /** Variable-length string of ANSI characters */
		SQL_BIT(0xFFF9),	/** Bit (1 or 0) */
		SQL_BINARY(0xFFFE); /** Fixed-length binary data */
    ...
    public String toString() { return "SXFDBType: " + wTypeSql + 
		Arrays.toString(this.getRecord()); }
    
    public int getType() { return wTypeSql; }
