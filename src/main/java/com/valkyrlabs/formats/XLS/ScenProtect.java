...
public final class ScenProtect extends com.valkyrlabs.formats.XLS.XLSRecord 
{
    /** 
	* serialVersionUID
	*/
    ...
    */
	...
	public void init(){
        ...
        if(this.getIsLocked()&&(DEBUGLEVEL > 3))Logger.logInfo("Scenario Protection Enabled.");
    }
}