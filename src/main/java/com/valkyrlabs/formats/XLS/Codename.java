 ...
 *
 */
public class Codename extends com.valkyrlabs.formats.XLS.XLSRecord {
...
byte grbitChr;
	...
	public void setName(String newname){
		   ...
		   }catch(UnsupportedEncodingException e){Logger.logInfo("UnsupportedEncodingException in setting sheet name: " + e);}
