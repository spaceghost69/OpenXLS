...
public class SxDI extends XLSRecord implements XLSConstants {
    ...
    String name = null;
    private final byte[] PROTOTYPE_BYTES = new byte[]{
            0, 0,    /* isxvdData */
            0, 0,    /* iiftab */
            0, 0,   /* df */
            0, 0,    /* isxvd */
    ...
    public void init() {
        ...
        isxvd = ByteTools.readShort(this.getByteAt(6), this.getByteAt(7));    // specifies a pivot field index used in calculations as specified by the df field.
        isxvi = ByteTools.readShort(this.getByteAt(8), this.getByteAt(9));    // A signed integer that specifies the pivot item used by df.
     ...
     */
    public enum DISPLAYTYPES {value, difference, percentageValue, percentageDifference, runningTotal, percentageTotalRow, percentageTotalCol, grandTotal, calculated}
}
