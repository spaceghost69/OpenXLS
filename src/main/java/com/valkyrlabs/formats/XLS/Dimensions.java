...
public class Dimensions extends com.valkyrlabs.formats.XLS.XLSRecord
{
    ...
    */
    public void setRowFirst(int c){
        ...
        if(dt.length > 4) System.arraycopy(b, 0, dt, 0, 4);
        this.rowFirst = c;
    }
    ...
    */
    public void setRowLast(int c){
        ...
        byte[] b = ByteTools.cLongToLEBytes(c);
        byte[] dt= this.getData();
        if(dt.length > 4)  System.arraycopy(b, 0, dt, 4, 4);
        this.rowLast = c;
    }
    ...
    */
    public void setColFirst(int c){
        ...
        byte[] dt= this.getData();
        if(dt.length > 4) System.arraycopy(b, 0, dt, 8, 2);
    ...
    */
    public void setColLast(int c){
        ...
        byte[] b = ByteTools.shortToLEBytes((short)c);
        byte[] dt= this.getData();
        if(dt.length > 4) System.arraycopy(b, 0, dt, 10, 2);
