...
public final class Index extends com.valkyrlabs.formats.XLS.XLSRecord implements XLSConstants {
    /**
     * serialVersionUID
     */
    ...
    private ArrayList dbcells = new ArrayList();
...
//        }
    ...
    void updateDbcellPointers() {
        ...
        for (int i = 0; i < dbcells.size(); i++) {
            Dbcell db = (Dbcell) dbcells.get(i);
