...
public final class Supbook extends com.valkyrlabs.formats.XLS.XLSRecord 
{
       ...
       this.getData();
        ...
        if (isGlobalRecord()) 
        	...
        	try {
		        ...
		        int ln= ByteTools.readShort(this.getByteAt(2),this.getByteAt(3));	// len of bytes of filename "encoded URL without sheetname"	        
