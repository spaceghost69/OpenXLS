 ...
 */
public final class Continue extends com.valkyrlabs.formats.XLS.XLSRecord 
{
	/** 
	* serialVersionUID
	*/
	...
	*/
	...
	boolean isBigRecContinue() {
		...
		if(this.predecessor.getLength()>=MAXRECLEN)return true;
		return false;
	}
	...
	private byte mygr;
	byte getGrbit(){
		if(this.data!=null)return this.data[0];
	...
	public void init(){
		 ...
		 if(DEBUGLEVEL > 2)Logger.logInfo(" init() GRBIT: " + String.valueOf(mygr) );
	 }
