...
public class Sxview extends XLSRecord implements XLSConstants
{
    ...
    */
	...
	public void init(){
        ...
        if(this.getLength() <= 0){  // Is this record populated?
            ...
            if (cchName > 0) {
                ...
                }catch(UnsupportedEncodingException e){Logger.logInfo("encoding PivotTable name in Sxview: " + e);}
        ...
        if (DEBUGLEVEL > 3) Logger.logInfo("SXVIEW: name:" + this.getTableName() + " iCache:" + iCache + " cDim:" + cDim + " cDimRw:" + cDimRw + " cDimCol:" + cDimCol + " cDimPg:" + cDimPg + " cDimData:" + cDimData + " cRw:" + cRw + " cCol:" + cCol +" datafieldname:" + DataFieldName);         
    }
     ...
     * <br>see getSxaxis4Data to determine whether this is a row or column position
     */
    public short getIpos4Data(){return ipos4Data;}
...
/*    	
	...
	*/
     ...
     * @return
     */
    public short getCDimRw(){return cDimRw;}    
     ...
     * @return
     */
    public short getCDimCol(){return cDimCol;}    
     ...
     * @return
     */
    public short getCDimPg(){return cDimPg;}
...
/*	    }*/
     ...
     * @return
     */
    public short getCDimData(){return cDimData;}
    ...
    public void addPivotLineToROWAxis(int repeat, int nLines, int type, short[] indexes) {
      ...
      * @return
      */
    public short getCRw(){return cRw;}
    ...
    */
    private void initGrbit(){
       if ((grbit1 & 0x1) == 0x1){fRwGrand = true;}else{fRwGrand=false;}
       if ((grbit1 & 0x2) == 0x2){fColGrand = true;}else{fColGrand=false;}
       if ((grbit1 & 0x8) == 0x8){fAutoFormat = true;}else{fAutoFormat=false;}
       if ((grbit1 & 0x10) == 0x10){fWH = true;}else{fWH=false;}
       if ((grbit1 & 0x20) == 0x20){fFont = true;}else{fFont=false;}
       if ((grbit1 & 0x40) == 0x40){fAlign = true;}else{fAlign=false;}
       if ((grbit1 & 0x80) == 0x80){fBorder = true;}else{fBorder=false;}
       if ((grbit2 & 0x1) == 0x1){fPattern = true;}else{fPattern=false;}
       if ((grbit2 & 0x2) == 0x2){fNumber = true;}else{fNumber=false;}
    ...
    */
     ...
     */
      ...
      * MUST be 0 if none of the axes have been assigned in this PivotTable view. 
      */
     public boolean getFRwGrand(){return fRwGrand;}
...
specifies whether the PivotTable contains grand totals for columns. MUST be 1 if none of the axes are assigned in this PivotTable view.        */
     public boolean getFColGrand(){return fColGrand;}
      ...
      */
       ...
       * @return
       */
     public boolean getFAutoFormat(){return fAutoFormat;}
     ...
     public boolean getFWH(){return fWH;}
      ...
      * @return
      */
     public boolean getFFont(){return fFont;}
      ...
      * @return
      */
     public boolean getFAlign(){return fAlign;}
     ...
     * @return
     */
     public boolean getFBorder(){return fBorder;}
      ...
      * @return
      */
     public boolean getFPattern(){return fPattern;}
     ...
     public boolean getFNumber(){return fNumber;}
    ...
    */
     ...
     */
    public short getRwFirst(){return rwFirst;}
     ...
     */
    public short getRwLast(){return rwLast;}
     ...
     */
    public short getColFirst(){return colFirst;}
     ...
     * sets the last column of the pivot table
     */
    public short getColLast(){return colLast;}
    ...
    public short getColFirstData(){return colFirstData;}
    ...
    */
    ...
    public short getItblAutoFmt(){return itblAutoFmt;}
    ...
    */
     ...
     */
    public String getTableName(){return PivotTableName;}
    ...
    */
    ...
    public String getDataName(){return DataFieldName;}
    ...
    */
    private void buildRgch(){
        ...
        }catch(UnsupportedEncodingException e){Logger.logInfo("encoding pivot table name in SXVIEW: " + e);}
...
//		byte[] b= ByteTools.cLongToLEBytes(sid);      	b= ByteTosols.append(new byte[] {0, 0}, b); // add 2 reserved bytes
		...
		addInit(initialrecs, sa, sheet);
		sa= SxAddl.getDefaultAddlRecord(SxAddl.ADDL_CLASSES.sxcView, SxcView.sxdTableStyleClient.sxd(), new byte[] {0, 0, 0, 0, 0, 0, 51, 0, 0, 0});	
		addInit(initialrecs, sa, sheet);
