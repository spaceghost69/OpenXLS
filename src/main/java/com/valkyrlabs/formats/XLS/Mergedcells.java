...
**/
public final class Mergedcells extends com.valkyrlabs.formats.XLS.XLSRecord {   
	...
	*/
	...
	public void update(){
		...
		data[1] = szbt[1];
		int pos =2;
		if(DEBUGLEVEL > DEBUG_LOW)Logger.logInfo("updating Mergedcell with " + nummerges + " merges.");
