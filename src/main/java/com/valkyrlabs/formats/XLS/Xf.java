...
public class Xf extends com.valkyrlabs.formats.XLS.XLSRecord {
    ...
    /**
     * Parses an escaped xml format pattern (from ooxml) and returns an com.valkyrlabs.OpenXLS compatible
     * pattern.
     * <p>
    ...
    void initXF() {
        ...
        // Logger.logInfo(com.valkyrlabs.OpenXLS.ExcelTools.getRecordByteDef(this));
    }
