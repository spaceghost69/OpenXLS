 ...
 *
 */
public class FeatHeadr  extends com.valkyrlabs.formats.XLS.XLSRecord {
    /** 
	* serialVersionUID
	*/
	...
	short isf= 0;
	int grbit= 0;
	boolean iprotObject, iprotScenario, iprotFormatCells, iprotFormatColumns, iprotFormatRows, iprotInsertColumns, iprotInsertRows, iprotInsertHyperlinks,
    ...
    /** default constructor
    */
    private byte[] PROTOTYPE_BYTES = {0x67,	0x08, // rt or record type 
    								...
    								0,0,0,0};    	// for enhanced protection, 4 bytes = protection rules
    /**
	...
	public void init(){
        ...
        if (isf==2) {// Enhanced Protection - only option supported for now - read last 4 bytes for enhanced protection settings
