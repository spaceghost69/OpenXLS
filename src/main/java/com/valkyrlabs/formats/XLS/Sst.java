...
import com.valkyrlabs.formats.OOXML.Ss_rPr;
 ...
 * @see Extsst
 */
public final class Sst extends com.valkyrlabs.formats.XLS.XLSRecord {
    ...
    byte[] deldata = null;
    int retpos = -1;
    ArrayList cbounds = new ArrayList();
    ArrayList sstgrbits = new ArrayList();
    ...
    private int putString(Unicodestring newString) {
        ++retpos;
        ((SstArrayList) stringvector).put(newString, Integer.valueOf(
                retpos));
        return retpos;
    }
    ...
    void updateUnicodestrings() {
        ...
        // reset defaults
        cbounds = new ArrayList();
        sstgrbits = new ArrayList();
