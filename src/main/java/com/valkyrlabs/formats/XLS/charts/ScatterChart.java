...
*/
     ...
     * @return
     */
    public StringBuffer getOOXML(String catAxisId, String valAxisId,
                                 String serAxisId) {
        ...
        if (style == null && this.getHasLines()) style = "line";
        if (style == null && this.getHasSmoothLines()) style = "smooth";
