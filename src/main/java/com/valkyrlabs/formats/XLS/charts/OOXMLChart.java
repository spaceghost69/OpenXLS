...
public class OOXMLChart extends Chart {
    ...
    public com.valkyrlabs.formats.OOXML.Legend ooxmlLegend = null;
    ...
    public OOXMLChart(Chart c, WorkBookHandle wbh) {
        ...
        //com.valkyrlabs.toolkit.Logger.log("BEFORE: chartArr: " + Arrays.toString(chartArr.toArray()));
        ...
        if (c.hasDataLegend()) {
            ooxmlLegend = com.valkyrlabs.formats.OOXML.Legend.createLegend(c.getLegend());
        }
        this.wbh = wbh;
    }
    ...
    public StringBuffer getOOXML(String catAxisId, String valAxisId, String serAxisId) {
        ...
        try {
            ...
            if (allCharts[0] != BUBBLECHART) {    // bubble threeD handled in series for some reason
            ...
            cooxml.append("\r\n");
            // legend
            if (this.ooxmlLegend != null) cooxml.append(this.ooxmlLegend.getOOXML());
...
//	    	<c:dispBlanksAs val="gap"/>	"gap", "span", "zero"  --> default	    	
            ...
            if (this.getTxPr() != null) { // text formatting
