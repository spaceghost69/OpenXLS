...
public class LineFormat extends GenericChartObject implements ChartObject {
    ...
    private final byte[] PROTOTYPE_BYTES = new byte[]{0, 0, 0, 0, 0, 0, -1, -1, 9, 0, 77, 0};    // no line default
    // TODO: Figure this out!!
    private final byte[] PROTOTYPE_BYTES_1 = new byte[]{-128, -128, -128, 0, 0, 0, 0, 0, 0, 0, 0, 0};
    ...
    public void init() {
        ...
        rgb = new java.awt.Color((data[0] < 0 ? 255 + data[0] : data[0]), (data[1] < 0 ? 255 + data[1] : data[1]), (data[2] < 0 ? 255 + data[2] : data[2]));
