...
class testformula {
	...
	public void testCalculation() {
		try {
			...
			com.valkyrlabs.toolkit.Logger.log(form.calculate().toString());
			...
			com.valkyrlabs.toolkit.Logger.log("cell not found" + e);
		} catch (FormulaNotFoundException e) {
			com.valkyrlabs.toolkit.Logger.log("No formula to change" + e);
		} catch (Exception e) {
	...
	void testFormulaCalc(String fs, String sh) {
		...
		if (sheetname.equalsIgnoreCase("Sheet1")) {
			try {
				...
				i = (Double) f.calculate();
				com.valkyrlabs.toolkit.Logger.log(i.toString());
				...
				b = (Boolean) f.calculate();
				com.valkyrlabs.toolkit.Logger.log(b.toString());
	...
	public void openSheet(String finp, String sheetnm) {
		...
		try {
			...
			com.valkyrlabs.toolkit.Logger.log("couldn't find worksheet" + e);
		}
