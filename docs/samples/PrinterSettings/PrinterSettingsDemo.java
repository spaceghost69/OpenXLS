...
public class PrinterSettingsDemo {
	...
	public static void main(String[] args) {
		try {
			...
			WorkBookHandle bk = new WorkBookHandle(
					System.getProperty("user.dir") + "/docs/samples/PrinterSettings/InvoiceTemplate.xls");
	...
	public void testPrinterSettings(WorkBookHandle book) {
		...
		// Paper Size
		assertEquals((short) PrinterSettingsHandle.PAPER_SIZE_LEDGER_17x11, printersetup.getPaperSize()); // TODO: find
																											// out what
																											// these are
		// Scaling
