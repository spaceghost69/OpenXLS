...
/**  Test manipulation of Excel Form objects using OpenXLS and NamedRanges
 * ------------------------------------------------------------
 * 
 */
public class testFormControls{
	...
	*/
	...
	void doit(String finpath, String sheetname){    
		com.valkyrlabs.OpenXLS.util.Logger.log("Begin parsing: " + workingdir + finpath);
		...
		try{
			...
			// confirm we got
			com.valkyrlabs.OpenXLS.util.Logger.log("Got 4 named ranges: " + checkbox +", "+ radio +", "+ list +", "+ selected);
...
//			 set currently selected list item
		...
		com.valkyrlabs.OpenXLS.util.Logger.log("Successfully read: " + newbook);
	}
