...
/**
 * This Class Demonstrates the basic functionality of of OpenXLS Format Handling.
*/
	...
	*/
	public void testFormats(){
		...
		for(int i = 0;i<testfiles.length;i++){
			finpath = testfiles[i];
			com.valkyrlabs.OpenXLS.util.Logger.log("====================== TEST: " + String.valueOf(i) + " ======================");
			sheetname = testfiles[++i];
			com.valkyrlabs.OpenXLS.util.Logger.log("=====================> " + finpath + ":" + sheetname);
	...
	void testBorders(String finpath, String sheetname){
		...
		try{
			...
			com.valkyrlabs.OpenXLS.util.Logger.log(i);
		}catch(Exception e){com.valkyrlabs.OpenXLS.util.Logger.log(e);}
	...
	void testFormats(String finpath, String sheetname){    
		...
		try{
			...
			sheet.setFooterText("Created by OpenXLS:" + WorkBookHandle.getVersion());
			String addr = "";
			for(int i = 1;i<50;i++){
			...
			cell1.setVal(555);     
			com.valkyrlabs.OpenXLS.util.Logger.log("CELL FCOLOR: " + cell1.getForegroundColor());
			com.valkyrlabs.OpenXLS.util.Logger.log("CELL FCOLOR: " + cell1.getBackgroundColor());
		}catch(Exception e){com.valkyrlabs.OpenXLS.util.Logger.log(e);}
