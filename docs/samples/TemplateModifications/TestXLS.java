 ...
 * 
 * We read in the Template file and add new cells and modify cells involved in a
 * Chart and formula calculations,
...
class testit {
    ...
    public void test(String args) {
        try {
            ...
            com.valkyrlabs.OpenXLS.util.Logger
                    .log("OpenXLS version " + WorkBookHandle.getVersion() + ".  WorkBook successfully loaded.");
            ...
            com.valkyrlabs.OpenXLS.util.Logger.log("The Cell Value of Sheet1:C35 is: " + s);
            ...
            com.valkyrlabs.OpenXLS.util.Logger.log("Retrieved Cell: " + d35);
            ...
            com.valkyrlabs.OpenXLS.util.Logger.log("Writing: " + foutpath);
            FileInputStream fis = new FileInputStream(foutpath);
            book = new WorkBookHandle(fis);
            com.valkyrlabs.OpenXLS.util.Logger.log(book.getName() + " re-read sucessfully.");
        } catch (java.io.IOException e) {
            com.valkyrlabs.OpenXLS.util.Logger.log("IOException in Tester.  " + e);
        } catch (CellNotFoundException e) {
            com.valkyrlabs.OpenXLS.util.Logger.log("Cell Not Found in Template.  " + e);
