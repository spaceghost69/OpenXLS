...
public class Compare2Spreadsheets {
     ...
     */
    public void testCompare2Spreadsheets(WorkBookHandle bk1, WorkBookHandle bk2)
    throws Exception{
    	...
    	while(it.hasNext()){
    		...
    		com.valkyrlabs.OpenXLS.util.Logger.log(getCellText(c1x));
    		
    		com.valkyrlabs.OpenXLS.util.Logger.log(getCellText(c2x));
