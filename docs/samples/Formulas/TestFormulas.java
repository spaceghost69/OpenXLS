...
class testformula{
	...
	public void testMultiChange() {
		try {
			...
			OpenXLS.writeBookToFile(wd + "testFormulas_out.xls",wbx);
	...
	public void testCalculation(){
		try{
			...
			com.valkyrlabs.OpenXLS.util.Logger.log(form.calculate().toString());
		...
		}catch(CellNotFoundException e){com.valkyrlabs.OpenXLS.util.Logger.log("cell not found" + e);
		}catch(FormulaNotFoundException e){com.valkyrlabs.OpenXLS.util.Logger.log("No formula to change" + e);
		}catch(Exception e){
    ...
    public void testFormula(){
        ...
        }catch(Exception e){com.valkyrlabs.OpenXLS.util.Logger.log("Exception in testFORMULA.testFormulaSeries(): " + e);}
    }
	...
	void testFormulaCalc(String fs, String sh){    
			...
			}catch(Exception e){Logger.logErr("TestFormulas failed.",e);}
			...
			if (sheetname.equalsIgnoreCase("Sheet1")){
				try{
					...
					i = (Double)f.calculate();
					com.valkyrlabs.OpenXLS.util.Logger.log(i.toString());
					...
					b = (Boolean)f.calculate();
					com.valkyrlabs.OpenXLS.util.Logger.log(b.toString());
				...
				}catch(CellNotFoundException e){Logger.logErr("TestFormulas failed.",e);}
				catch(FunctionNotSupportedException e){Logger.logErr("TestFormulas failed.",e);}
				catch(Exception e){Logger.logErr("TestFormulas failed.",e);}
