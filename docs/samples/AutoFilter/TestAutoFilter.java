...
/**
    ...
    This Class Demonstrates the AutoFilter Functionality of OpenXLS
...
public class TestAutoFilter {
    ...
    /**
     * Test OpenXLS handling of AutoFilters
     * ------------------------------------------------------------
     * 
     * @param args
     */
   ...
   private void addAF(String condition, int col) {
	    ...
	    try        
	    {
			...
			for (int i= 0; i < split.length; i++) {
	        	...
	        	else if (cond.equals(">=2.0 AND <=10.0")) {		// set a "Betweens" condition 
