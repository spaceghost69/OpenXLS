...
public class Excel2007Test{
    ...
    /**
     * Test OpenXLS handling of Excel 2007 (XLSX) files
     * ------------------------------------------------------------
     * 
     * @param args
     */
    ...
    public void testWrite(){
        ...
        try{
            ...
            if(WRITE_AUTO){ // to auto-detect file type, use WorkBookHandle.write(OutputStream out) method
            	book.write(fos);
            }else if(WRITE_XLS){ // we can write out XLS explicitly if we like
                ...
                fos.flush();
                fos.close();
            }else if(WRITE_XLSX){ // we can write out XLSX explicitly if we like
